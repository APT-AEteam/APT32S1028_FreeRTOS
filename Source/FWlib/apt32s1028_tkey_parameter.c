/*
  ******************************************************************************
  * @file    apt32s1028_tkey_parameter.c
  * @author  APT AE Team
  * @version V1.03
  * @date    2020/11/24
  ******************************************************************************
...
//TK parameter define
*****************************************************/
	TK_IO_ENABLE=0B00000011111000000;				//TK IO ENABLE Bit16-->Bit0;0=DISABLE 1=ENABLE
	...
	TK_Triggerlevel[0]=255;							//TCH0 TK_Trigger level
	TK_Triggerlevel[1]=255;							//TCH1 TK_Trigger level
	TK_Triggerlevel[2]=255;							//TCH2 TK_Trigger level
	TK_Triggerlevel[3]=255;							//TCH3 TK_Trigger level
	TK_Triggerlevel[4]=255;							//TCH4 TK_Trigger level
	TK_Triggerlevel[5]=255;							//TCH5 TK_Trigger level
	...
	TK_Triggerlevel[11]=255;						//TCH11 TK_Trigger level
	TK_Triggerlevel[12]=255;						//TCH12 TK_Trigger level
	TK_Triggerlevel[13]=255;						//TCH13 TK_Trigger level
	TK_Triggerlevel[14]=255;						//TCH14 TK_Trigger level
	TK_Triggerlevel[15]=255;						//TCH15 TK_Trigger level
	TK_Triggerlevel[16]=255;						//TCH16 TK_Trigger level
...
*****************************************************/
	...
	TK_Lowpower_level=3;							//0=20ms 1=50ms 2=100ms 3=150ms 4=200ms,Scan interval when sleep
	TK_Wakeup_level=30;								//touch key Trigger level in sleep
/****************************************************
